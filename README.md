...
A simple and fast **real-time chat app** where users can join and communicate instantly.  
Built with modern web technologies for seamless communication.
...
- Secure user authentication (wokring on it)  
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Khalid-Tarazi/Real-Time-Chat-App.git
